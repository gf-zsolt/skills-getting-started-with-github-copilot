...
activities = {
    ...
    "Drama Club": {
        "description": "Prepare scenes, improvise, and put on school performances",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["sophia@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and argument skills through debate",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["grace@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments, research, and scientific challenges",
